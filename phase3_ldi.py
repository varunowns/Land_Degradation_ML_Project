...
# ─────────────────────────── Setup ────────────────────────────────────────────
os.makedirs('plots/Phase3', exist_ok=True)
...
plt.tight_layout()
plt.savefig('plots/Phase3/1_ldi_distribution.png', **SAVE_KW)
plt.close()
...
plt.tight_layout()
plt.savefig('plots/Phase3/2_ldi_by_year.png', **SAVE_KW)
plt.close()
...
ax.legend()
plt.tight_layout()
plt.savefig('plots/Phase3/3_district_ldi.png', **SAVE_KW)
plt.close()
...
plt.tight_layout()
plt.savefig('plots/Phase3/4_ldi_validation_corr.png', **SAVE_KW)
plt.close()
...
plt.tight_layout()
plt.savefig('plots/Phase3/5_ldi_scatter_validation.png', **SAVE_KW)
plt.close()
print("   Saved: plots/Phase3/5_ldi_scatter_validation.png")

# ─────────────────────────── 10. Save LDI Dataset ────────────────────────────
df.to_csv('ldi_dataset.csv', index=False)
