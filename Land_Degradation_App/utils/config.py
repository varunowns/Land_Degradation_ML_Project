...
LATEST_PREDICTIONS_PATH = ML_PROJECT_ROOT / "results" / "latest_predictions.csv"
...
PAGES = [
    ...
    {"file": "pages/10_Settings.py", "label": "Settings", "icon": "⚙️"},
