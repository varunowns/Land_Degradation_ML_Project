...
def run_phase2_eda():
    ...
    with open('eda_stats.txt', 'w') as f:
        ...
        plt.tight_layout()
        plt.savefig('plots/EDA/1_env_distributions.png', dpi=300)
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig('plots/EDA/2_env_boxplots.png', dpi=300)
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig('plots/EDA/3_lulc_distributions.png', dpi=300)
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig('plots/EDA/4_pearson_heatmap.png', dpi=300)
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig('plots/EDA/5_spearman_heatmap.png', dpi=300)
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig('plots/EDA/6_temporal_trends.png', dpi=300)
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig('plots/EDA/7_district_ndvi.png', dpi=300)
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig('plots/EDA/8_relationships.png', dpi=300)
        plt.close()
        ...
        plt.savefig('plots/EDA/9_pairplot.png', dpi=300)
        plt.close()
